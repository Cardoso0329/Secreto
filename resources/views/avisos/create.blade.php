    ...
    <div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
        <div class="card shadow-sm w-100" style="max-width: 600px; border-radius: 1rem;">
            <div class="card-body p-4">
                <h3 class="text-center mb-4" style="font-weight: 600; color: #343a40;">Criar Novo Aviso</h3>
                ...
                <form action="{{ route('avisos.store') }}" method="POST">
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        ...
                        <a href="{{ route('avisos.index') }}" class="btn btn-outline-secondary rounded-pill px-4">Voltar</a>
                    </div>
                </form>
            </div>
        </div>
