...
<div class="container mt-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold mb-0">Lista de Origens</h2>
        <div>
            <a href="{{ route('origens.create') }}" class="btn btn-primary">
                Criar Nova Origem
            </a>
        </div>
    </div>
                ...
                <tbody>
                    @forelse ($origens as $origem)
                        <tr>
                            <td>{{ $origem->name }}</td>
                            <td class="text-end">
                                <a href="{{ route('origens.show', $origem->id) }}" class="btn btn-sm btn-outline-success me-1">Ver</a>
