                    ...
                    @forelse($logs as $log)
                        ...
                        <tr>
                            ...
                            <td class="small" style="max-width: 260px;">
                                <div class="text-truncate" title="{{ $to }}">
                                    {{ $to ?: '—' }}
                                </div>
                            </td>

                            <td class="small" style="max-width: 280px;">
                                <div class="text-truncate" title="{{ $log->subject }}">
                                    {{ $log->subject ?: '—' }}
                                </div>
                            </td>

                            <td class="text-end">
                                <a href="{{ route('email_logs.show', $log) }}"
